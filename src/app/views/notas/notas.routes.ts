...
import { ListagemNotasArquivadasComponent } from './listar-arquivadas/listagem-notas-arquivadas.component';
...
export const notasRoutes: Routes = [
  ...
  { path: 'arquivadas', component: ListagemNotasArquivadasComponent },
];
